  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      columnDefs: [{
        ...
        orderable: false,
        render: function render(data, type, full, meta) {
          return '<div class="d-inline-block text-nowrap">' + "<button class=\"btn btn-sm btn-icon edit-record\" data-id=\"".concat(full['id'], "\" ><a href=\"edit/depense/").concat(full['id'], "\"><i class=\"ti ti-edit\"></i></a></button>") + "<button class=\"btn btn-sm btn-icon delete-record\" data-id=\"".concat(full['id'], "\"><i class=\"ti ti-trash\"></i></button>") + '</div>';
        }
      }],
      order: [[2, 'desc']],
  ...
  $(document).on('click', '.delete-record', function () {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          type: 'GET',
          url: "".concat(baseUrl, "delete/depense/").concat(depense_id),
