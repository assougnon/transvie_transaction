...
// Datatable (jquery)
$(function () {
  var dt_remise_table = $('.remise-list-table'), dateFormat = 'DD/MM/YYYY';
    ...
    var dt_invoice = dt_remise_table.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          <img src="${baseUrl+full['remise']}" alt="" data-id="${full['remise']}" data-bs-toggle="modal" data-bs-target="#pricingModal" class="show-modal rounded-pill">
          </div>
          </div>
            </div>`;
            return $output;
