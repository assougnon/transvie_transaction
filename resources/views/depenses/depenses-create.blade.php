...
@section('content')
  ...
  <div class="card mb-4">
    ...
    <form class="card-body" method="POST" action="/create/depense">
      @csrf
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <div class="input-group input-group-merge">
            <input type="number" name="depense" id="multicol-montant" class="form-control @error('depense') is-invalid @enderror" placeholder="12300000" aria-label="100000" aria-describedby="multicol-montant"  autocomplete="false"/>
            @error('depense')
        ...
        <div class="col-md-6">
          ...
          <input type="text" id="multicol-note" class="form-control @error('description') is-invalid @enderror" placeholder="Ex: Numero virement" name="description" />
          @error('description')
          <span class="invalid-feedback" role="alert">
              <span class="fw-medium">{{ $message }}</span>
            </span>
