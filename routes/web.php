...
// Main Page Route
Route::get('/', [MiscUnderMaintenance::class, 'index']);
...
Route::get('/app/facture/print/{id}', [InvoicePrint::class, 'printInvoice'])->name('app-facture-print');
...
Route::get('/app/user/view/account/{userId}', [UserViewAccount::class, 'index'])->name('app-user-view-account');
...
Route::get('statistiques/chaque',[DashboardController::class,'montantDeChaqueAgence']);
